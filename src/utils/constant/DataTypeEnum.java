...
public enum DataTypeEnum {
	STRING("CHAR", "String"), VARCHAR("VARCHAR", "String"), LONGVARCHAR("LONGVARCHAR", "String"), NUMERIC("NUMERIC", "java.math.BigDecimal"), DECIMAL("DECIMAL",
			"java.math.BigDecimal"), BIT("BIT", "Boolean"), TINYINT("TINYINT", "Integer"), // Byte
	SMALLINT("SMALLINT", "Integer"), // Short
	INT("INT", "Integer"), INTEGER("INTEGER", "Integer"), BIGINT("BIGINT", "Long"), REAL("REAL", "Float"), FLOAT("FLOAT", "Double"), DOUBLE("DOUBLE", "Double"), DATE("DATE",
			"Date"), // java.util.Date
